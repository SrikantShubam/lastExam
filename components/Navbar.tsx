...
//                 >
//                   <Image
//                     src={user?.photoURL || "https://eu.ui-avatars.com/api/?name=John+Doe&size=32"}
//                     alt="User profile"
//                     width={32}
//                     height={32}
//                     className="rounded-full"
//                     onError={(e) => {
//                       e.currentTarget.src = "https://eu.ui-avatars.com/api/?name=John+Doe&size=32";
//                     }}
//                   />
//                 </HeadlessMenu.Button>
//                 <Transition
...
//   // Check user login status on mount
//   useEffect(() => {
//     console.log("Auth state change listener mounted");
//     const unsubscribe = onAuthStateChanged(auth, (currentUser) => {
...
//     });
//     return () => {
//       console.log("Auth state change listener unmounted");
//       unsubscribe();
//     };
//   }, []);
...
//   // Close menu if user clicks outside
//   useEffect(() => {
//     console.log("Click outside listener mounted");
//     const handleClickOutside = () => {
//       if (menuOpen) setMenuOpen(false);
//     };
...
//     document.addEventListener("click", handleClickOutside);
//     return () => {
//       console.log("Click outside listener unmounted");
//       document.removeEventListener("click", handleClickOutside);
//     };
//   }, [menuOpen]);
...
import { memo, FC, useState, useEffect } from "react"; // Added useEffect here
import Link from "next/link";
import Image from "next/image";
import { Menu, X, Moon, Sun, LogOut } from "lucide-react";
import { Menu as HeadlessMenu, Transition } from "@headlessui/react";
...
// Set displayName for memoized component to avoid ESLint warning
